  ...
  <header class="report-top">
    ...
    <div class="report-header-actions report-header-actions--desktop">
      ...
      <button
        ...
        aria-label="Generate proposal draft"
      ...
      >
        ...
        <span class="btn-proposal-cta__text btn-proposal-cta__text--full">Generate Proposal Draft</span>
        <span class="btn-proposal-cta__text btn-proposal-cta__text--short">Proposal</span>
      </button>
      <button
        v-if="variant === 'saved'"
        type="button"
